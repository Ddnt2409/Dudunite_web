...
import { collection, addDoc, getDocs, serverTimestamp, query, where, Timestamp, doc, updateDoc, deleteDoc } from "firebase/firestore";
...
// Fn04 + Fn05 – Estados Iniciais e Abertura do Componente
const App = () => {
