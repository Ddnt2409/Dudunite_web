// src/pages/HomePCP.jsx import React, { useState } from 'react'; import './HomePCP.css';

export default function HomePCP({ setTela }) { const [saboresZoomed, setSaboresZoomed] = useState(false);

return ( <div className="homepcp-container"> {/* === HEADER === */} <div className="homepcp-header"> <img
src="/LogomarcaDDnt2025Vazado.png"
alt="Logo Dudunitê"
className="logo-pcp"
/> <h1 className="homepcp-titulo">PCP – Planejamento de Produção</h1> </div>
  ...
  <div className="botoes-pcp">
    ...
    <div className="botao-wrapper">
      <button
        ...
        onDoubleClick={() => setTela('AliSab')}       // 2º clique (double): vai para Alimentar Sabores
      >
        🍫<br />
        Alimentar Sabores
      </button>
